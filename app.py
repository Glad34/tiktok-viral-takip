...
# --- YENİ SIDEBAR YAPISI (RADIO BUTON GERİ GELDİ) ---
...
# Seçim İşlemleri
if selected_label == "────────────────":
    # Ayırıcıya tıklanırsa eski sayfada kal
    st.rerun()
else:
